...
public class SubListSerializersTest {
  ...
  public void testSubList() throws Exception {
    final List<TestEnum> subList =
        new LinkedList<TestEnum>(Arrays.asList(TestEnum.values())).subList(1, 2);
    doTest(subList);
  }
  ...
  public void testArrayListSubList() throws Exception {
    final List<TestEnum> subList =
        new ArrayList<TestEnum>(Arrays.asList(TestEnum.values())).subList(1, 2);
    doTest(subList);
  }
  ...
  public void testNestedArrayListSubListWithSharedItems_1() throws Exception {
    ...
    final List<List<String>> lists =
        new ArrayList<List<String>>(Arrays.asList(l1s1, l1s2, l2s1, l1, l2));
  ...
  public void testNestedArrayListSubListWithSharedItems_2() throws Exception {
    ...
    final List<List<String>> lists =
        new ArrayList<List<String>>(Arrays.asList(l1, l2, l1s1, l1s2, l2s1));
