...
public class ImmutableTableSerializerTest {
  ...
  public void testEmpty() {
    ...
    final ImmutableTable<?, ?, ?> deserialized =
        deserialize(_kryo, serialized, ImmutableTable.class);
  ...
  public void testDense() {
    final ImmutableTable<?, ?, ?> obj =
        ImmutableTable.builder().put("a", 1, 1).put("b", 1, 1).build();
    final byte[] serialized = serialize(_kryo, obj);
    final ImmutableTable<?, ?, ?> deserialized =
        deserialize(_kryo, serialized, ImmutableTable.class);
    assertEquals(deserialized, obj);
  ...
  public void testSparse() {
    final ImmutableTable<?, ?, ?> obj =
        ImmutableTable.builder().put("a", 1, 1).put("b", 2, 1).build();
    final byte[] serialized = serialize(_kryo, obj);
    final ImmutableTable<?, ?, ?> deserialized =
        deserialize(_kryo, serialized, ImmutableTable.class);
    assertEquals(deserialized, obj);
