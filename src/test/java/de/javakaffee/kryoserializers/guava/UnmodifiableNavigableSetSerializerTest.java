...
public class UnmodifiableNavigableSetSerializerTest {
  ...
  {
    unmodifiableClass =
        (Class<NavigableSet>) Sets.unmodifiableNavigableSet(new TreeSet()).getClass();
  }
  ...
  public void testEmptyTreeSet() {
    ...
    try {
      deserialized.add("a");
      fail(
          "Should have been unable to add a field to an unmodifiable collection post deserialization");
