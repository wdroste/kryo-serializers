...
public class TreeMultimapSerializerTest extends MultimapSerializerTestBase {
  ...
  public void testDifferentKeyComparatorCopy() {
    final TreeMultimap<TestClasses.Person, String> multimap =
        TreeMultimap.create(CompareByAge.INSTANCE, Ordering.natural());
  ...
  public void testDifferentKeyComparatorSerialize() {
    ...
    final byte[] serialized = KryoTest.serialize(_kryo, multimap);
    final TreeMultimap<TestClasses.Person, String> deserialized =
        KryoTest.deserialize(_kryo, serialized, TreeMultimap.class);
  ...
  public void testDifferentValueComparatorCopy() {
    final TreeMultimap<String, TestClasses.Person> multimap =
        TreeMultimap.create(Ordering.<String>natural(), CompareByAge.INSTANCE);
  ...
  public void testDifferentValueComparatorSerialize() {
    ...
    final byte[] serialized = KryoTest.serialize(_kryo, multimap);
    final TreeMultimap<String, TestClasses.Person> deserialized =
        KryoTest.deserialize(_kryo, serialized, TreeMultimap.class);
