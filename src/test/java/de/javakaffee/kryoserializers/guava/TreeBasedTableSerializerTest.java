...
public class TreeBasedTableSerializerTest extends TableSerializerTestBase {
  ...
  public void testTable(Object[] contents) {
    ...
    final TreeBasedTable<Comparable, Comparable, Object> deserialized =
        KryoTest.deserialize(_kryo, serialized, TreeBasedTable.class);
  ...
  public void testDifferentRowComparatorCopy() {
    final TreeBasedTable<TestClasses.Person, String, String> table =
        TreeBasedTable.create(
            TreeBasedTableSerializerTest.CompareByAge.INSTANCE, Ordering.natural());

    // Natural order: "Alice" < "Bob"; by age: "Bob" < "Alice"
    table.put(
        TestClasses.createPerson("Alice", TestClasses.Person.Gender.FEMALE, 20), "foo", "bar");
  ...
  public void testDifferentRowComparatorSerialize() {
    ...
    final byte[] serialized = KryoTest.serialize(_kryo, table);
    final TreeBasedTable<TestClasses.Person, String, String> deserialized =
        KryoTest.deserialize(_kryo, serialized, TreeBasedTable.class);
  ...
  public void testDifferentColumnComparatorCopy() {
    final TreeBasedTable<String, TestClasses.Person, String> table =
        TreeBasedTable.create(
            Ordering.natural(), TreeBasedTableSerializerTest.CompareByAge.INSTANCE);

    // Natural order: "Alice" < "Bob"; by age: "Bob" < "Alice"
    table.put(
        "foo", TestClasses.createPerson("Alice", TestClasses.Person.Gender.FEMALE, 20), "bar");
  ...
  public void testDifferentColumnComparatorSerialize() {
    ...
    final byte[] serialized = KryoTest.serialize(_kryo, table);
    final TreeBasedTable<String, TestClasses.Person, String> deserialized =
        KryoTest.deserialize(_kryo, serialized, TreeBasedTable.class);
  ...
  private static class CompareByAge implements Comparator<TestClasses.Person> {
    private static final TreeBasedTableSerializerTest.CompareByAge INSTANCE =
        new TreeBasedTableSerializerTest.CompareByAge();
