...
public class ImmutableSortedMapSerializerTest {
  ...
  public void testEmpty() {
    ...
    final ImmutableSortedMap<?, ?> deserialized =
        deserialize(_kryo, serialized, ImmutableSortedMap.class);
  ...
  public void testDescending() {
    final ImmutableSortedMap<?, ?> obj =
        ImmutableSortedMap.of(1, "a", 5, "e", 3, "c").descendingMap();
    final byte[] serialized = serialize(_kryo, obj);
    final ImmutableSortedMap<?, ?> deserialized =
        deserialize(_kryo, serialized, ImmutableSortedMap.class);
    assertEquals(deserialized, obj);
