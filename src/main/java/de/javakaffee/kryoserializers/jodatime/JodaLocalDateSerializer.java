 ...
 *
 * <p>Note that internally the LocalDate object makes use of an iLocalMillis value, but that field
 * is not accessible for reading here because the getLocalMillis() method is protected. There could
