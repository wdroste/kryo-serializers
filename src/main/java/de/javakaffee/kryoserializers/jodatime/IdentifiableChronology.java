...
/**
 * An enumeration that provides a String id for subclasses of {@link Chronology}. For {@link
 * ISOChronology}, <code>null</code> is used as id, as {@link ISOChronology} is used as default and
 * the id does not have to be serialized.
 *
...
enum IdentifiableChronology {
  ...
  /**
   * Determines the id for the given {@link Chronology} subclass that later can be used to resolve
   * the {@link Chronology} with {@link #valueOfId(String)}. For {@link ISOChronology} class <code>
   ...
   */
  public static String getIdByChronology(final Class<? extends Chronology> clazz)
  ...
  /**
   * Returns the chronology of the {@link IdentifiableChronology} matching the provided <code>id
   * </code>. If the provided <code>id</code> is <code>null</code>, {@link ISOChronology} is
   * returned.
   *
