...
public class UnmodifiableNavigableSetSerializer extends Serializer<NavigableSet<?>> {
  ...
  public UnmodifiableNavigableSetSerializer() {
    ...
    } catch (IllegalArgumentException | ClassNotFoundException | SecurityException | NoSuchFieldException e) {
  ...
  /**
   * Creates a new {@link UnmodifiableNavigableSetSerializer} and registers its serializer for the
   * UnmodifiableNavigableSetSerializer related class.
   *
   * @param kryo the {@link Kryo} instance to set the serializer on
   */
  public static void registerSerializers(final Kryo kryo) {
    final UnmodifiableNavigableSetSerializer serializer = new UnmodifiableNavigableSetSerializer();
    kryo.register(Sets.unmodifiableNavigableSet(new TreeSet<>()).getClass(), serializer);
  }
}
