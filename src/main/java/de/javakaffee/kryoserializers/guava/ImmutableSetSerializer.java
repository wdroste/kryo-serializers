 ...
 *     (the array.clone as done by copyOf is saved), for more elements copyOf seems to get more
 *     efficient.
 */
public class ImmutableSetSerializer extends Serializer<ImmutableSet<Object>> {
  ...
  public ImmutableSet<Object> read(
      Kryo kryo, Input input, Class<? extends ImmutableSet<Object>> type) {
