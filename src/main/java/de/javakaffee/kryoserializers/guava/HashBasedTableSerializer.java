...
public class HashBasedTableSerializer<R, C, V>
    extends TableSerializerBase<R, C, V, HashBasedTable<R, C, V>> {
  ...
  @Override
  public HashBasedTable<R, C, V> read(
      Kryo kryo, Input input, Class<? extends HashBasedTable<R, C, V>> type) {
