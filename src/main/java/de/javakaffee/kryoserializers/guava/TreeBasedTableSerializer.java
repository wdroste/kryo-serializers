...
public class TreeBasedTableSerializer<R extends Comparable, C extends Comparable, V>
  ...
  @Override
  public TreeBasedTable<R, C, V> read(
      Kryo kryo, Input input, Class<? extends TreeBasedTable<R, C, V>> type) {
    Comparator<? super Comparable> rowComparator =
        (Comparator<? super Comparable>) kryo.readClassAndObject(input);
    Comparator<? super Comparable> columnComparator =
        (Comparator<? super Comparable>) kryo.readClassAndObject(input);
