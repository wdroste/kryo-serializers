...
public class ImmutableSortedMapSerializer
  ...
  @Override
  public void write(
      Kryo kryo, Output output, ImmutableSortedMap<Object, ? extends Object> immutableMap) {
    kryo.writeObject(output, Maps.newTreeMap(immutableMap));
  }

  @Override
  public ImmutableSortedMap<Object, Object> read(
      Kryo kryo, Input input, Class<? extends ImmutableSortedMap<Object, ? extends Object>> type) {
    Map map = kryo.readObject(input, TreeMap.class);
    return ImmutableSortedMap.copyOf(map);
  }

  /**
   * Creates a new {@link ImmutableSortedMapSerializer} and registers its serializer for the several
