...
public class ImmutableMultimapSerializer extends Serializer<ImmutableMultimap<Object, Object>> {
  ...
  public ImmutableMultimap<Object, Object> read(
      Kryo kryo, Input input, Class<? extends ImmutableMultimap<Object, Object>> type) {
  ...
  /**
   * Creates a new {@link ImmutableMultimapSerializer} and registers its serializer for the several
   * ImmutableMultimap related classes.
   *
